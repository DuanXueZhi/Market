...
const fnChangeSpell = (chinese) => {
  ...
  var nameArray = chinese.split('') // 分割参数
  var reg = new RegExp('[\\u4E00-\\u9FFF]') // 中文正则
  var nameFullSpell = '' // 全拼字符串
  var nameFirstSpell = '' // 首拼字符串
  nameArray.forEach(v => {
    if (reg.test(v)) {
      // console.log('是汉字')
  ...
  // console.log(nameFullSpell)
  // console.log(nameFirstSpell)
  return [nameFullSpell, nameFirstSpell]
}
// 首字母大写（返回值：[0]：全拼，[1]：仅首拼）
const fnUcFirst = function (l1) {
  if (l1.length > 0) {
